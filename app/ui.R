...
ui <- fluidPage(
  padding = 0, title = "Forecast Eval Dashboard",
  tags$head(
  ...
  div(
    ...
    div(
      id = "title", class = "col-sm-6",
      HTML(
        "FORECAST <span id='bold-title'>EVALUATION DASHBOARD</span> <a id='back-button' href='https://delphi.cmu.edu'>",
        includeHTML("assets/arrow-left.svg"),
        "   Back</a>"
      ),
    ),
    div(
      id = "github-logo-container", class = "col-sm-1",
      a(
        id = "github-logo", href = "https://github.com/cmu-delphi/forecast-eval/",
        includeHTML("assets/github.svg"),
        HTML("&nbsp;GitHub")
      )
    ),
  ),
